...
#define ID_CAPT_PILE     5    // ID dans la trame du capeur de temperature
...
#define NB_VAL_GPS       5    // Nombre de valeurs du capteur GPS
#define ID_VAL_LAT_DEG   0    // No de la valeur "Degres latitude" dans la trame
#define ID_VAL_LON_DEG   1    // No de la valeur "Degres longitude" dans la trame
#define ID_VAL_VIT       2    // No de la valeur "Vitesse" dans la trame
#define ID_VAL_UTIME     3    // No de la valeur "temps UTC" dans la trame
#define ID_VAL_ALT       4    // No de la valeur "temps UTC" dans la trame
